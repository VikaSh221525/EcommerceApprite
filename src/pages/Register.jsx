                    ...
                    <div className='w-full max-w-[60rem] mx-auto flex flex-col md:flex-row bg-gray-100 rounded-2xl overflow-hidden'>
                        ...
                        <div className='w-full md:w-1/2 px-6 sm:px-10 pt-10 md:pt-20 pb-10 md:pb-15'>
                            <form onSubmit={handleSubmit(RegisterHandler)} className='flex flex-col gap-7'>
                                ...
                                <input type="submit" value={`Register`} className='bg-blue-500 text-white px-12 py-2 rounded-4xl hover:bg-blue-600 transition duration-200 cursor-pointer shadow-md w-full md:w-auto' />
                            </form>

                            <div className='mt-10'>
                                <p className='text-gray-500 flex items-center gap-3'>Create account with <span><img src="/facebook.png" alt="Facebook" className='w-6 h-6' /></span> <span><img src="/google.png" alt="Google" className='w-6 h-6' /></span> </p>
                            </div>
                            <div className='mt-5'>
